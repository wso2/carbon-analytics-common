...
public final class SQSEventAdapterConstants {
    ...
    public static final String MAX_NUMBER_OF_MSGS = "maxNumberOfMessages";
    ...
    public static final String POLLING_INTERVAL_HINT = "Interval (in milliseconds) between two message retrieval " +
            "operations";
    public static final String WAIT_TIME_HINT = "The maximum amount of time (in seconds) that a polling call " +
            "will wait for a message to become available in the queue.";
