...
public class FileSystemStreamDefnStoreDSTestCase extends FileSystemStreamDefnStoreDS {
    ...
    private EventStreamService carbonEventStreamService = new CarbonEventStreamService();
    ...
    @Test
    public void testEventStreamService() {
        setEventStreamService(carbonEventStreamService);
        unsetEventStreamService(carbonEventStreamService);
    }
