        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.analytics.dashboard.admin.data.Widget[] local_return ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  org.wso2.carbon.analytics.dashboard.admin.data.Widget[] get_return(){
                               return local_return;
                           }
                               ...
                               */
                              protected void validate_return(org.wso2.carbon.analytics.dashboard.admin.data.Widget[] param){
                              ...
                              * @param param _return
                              */
                              public void set_return(org.wso2.carbon.analytics.dashboard.admin.data.Widget[] param){
                             ...
                             */
                             public void add_return(org.wso2.carbon.analytics.dashboard.admin.data.Widget param){
                                   if (local_return == null){
                                   local_return = new org.wso2.carbon.analytics.dashboard.admin.data.Widget[]{};
                                   }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getWidgetsResponse".equals(type)){
                                ...
                                return (GetWidgetsResponse)org.wso2.carbon.analytics.dashboard.admin.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(org.wso2.carbon.analytics.dashboard.admin.data.Widget.Factory.parse(reader));
                                                                }
                                                        ...
                                                        object.set_return((org.wso2.carbon.analytics.dashboard.admin.data.Widget[])
