...
/**
 * AddWidgetToDashboardResponse.java
 *
 ...
 */
            ...
            /**
            *  AddWidgetToDashboardResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddWidgetToDashboardResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://admin.dashboard.analytics.carbon.wso2.org",
                "addWidgetToDashboardResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addWidgetToDashboardResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addWidgetToDashboardResponse",
    ...
    public static class Factory{
        ...
        */
        public static AddWidgetToDashboardResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddWidgetToDashboardResponse object =
                new AddWidgetToDashboardResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addWidgetToDashboardResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddWidgetToDashboardResponse)org.wso2.carbon.analytics.dashboard.admin.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
