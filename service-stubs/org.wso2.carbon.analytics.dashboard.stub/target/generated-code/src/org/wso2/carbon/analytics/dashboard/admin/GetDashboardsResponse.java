        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[] local_return ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[]
                           */
                           public  org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[] get_return(){
                               return local_return;
                           }
                               ...
                               */
                              protected void validate_return(org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[] param){
                              ...
                              * @param param _return
                              */
                              public void set_return(org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[] param){
                             ...
                             * @param param org.wso2.carbon.analytics.dashboard.admin.data.Dashboard
                             */
                             public void add_return(org.wso2.carbon.analytics.dashboard.admin.data.Dashboard param){
                                   if (local_return == null){
                                   local_return = new org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(local_return);
                               list.add(param);
                               this.local_return =
                             (org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[])list.toArray(
                            new org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[list.size()]);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDashboardsResponse".equals(type)){
                                ...
                                return (GetDashboardsResponse)org.wso2.carbon.analytics.dashboard.admin.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(org.wso2.carbon.analytics.dashboard.admin.data.Dashboard.Factory.parse(reader));
                                                                }
                                                        ...
                                                        object.set_return((org.wso2.carbon.analytics.dashboard.admin.data.Dashboard[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.wso2.carbon.analytics.dashboard.admin.data.Dashboard.class,
                                                                list1));
