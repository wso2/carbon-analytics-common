 ...
 */
            ...
            /**
            *  AddDashboardResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddDashboardResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addDashboardResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addDashboardResponse",
    ...
    public static class Factory{
        ...
        */
        public static AddDashboardResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddDashboardResponse object =
                new AddDashboardResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addDashboardResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddDashboardResponse)org.wso2.carbon.analytics.dashboard.admin.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
